...
// =============================================================================
// FolderRemapper HasRemap Tests
// =============================================================================

// TestFolderRemapper_HasRemap_True verifies HasRemap returns true when remaps exist.
func TestFolderRemapper_HasRemap_True(t *testing.T) {
	tmpDir := t.TempDir()
	...
	if !remapper.HasRemap() {
		t.Error("HasRemap should return true when remaps exist")
	}
}

// TestFolderRemapper_HasRemap_False verifies HasRemap returns false when no remaps.
func TestFolderRemapper_HasRemap_False(t *testing.T) {
	tmpDir := t.TempDir()

	filenames := []string{"NewFolder/beach.jpg"}
	...
	if remapper.HasRemap() {
		t.Error("HasRemap should return false when no remaps exist")
	}
}
